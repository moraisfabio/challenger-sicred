package com.challenger.managevotes.data.controller.v1.schedule;

import com.challenger.managevotes.domain.dtos.schedule.ScheduleDTO;
import com.challenger.managevotes.domain.dtos.schedule.ScheduleResponseDTO;
import com.challenger.managevotes.domain.entities.schedule.Schedule;
import com.challenger.managevotes.data.services.schedule.ScheduleServiceImpl;
...
public class SchedulesController {
    ...
    public ResponseEntity<ScheduleDTO> newSchedule(@RequestBody @Valid ScheduleDTO scheduleDTO){
        ...
        return ResponseEntity.ok(objectMapper.convertValue(schedule, ScheduleResponseDTO.class))
